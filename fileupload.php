...
if (isset($_POST["Import"])) {
    ...
    if ($_FILES["file"]["size"] > 0) {
        ...
        while (($emapData = fgetcsv($file, 10000, ",")) !== FALSE) {
            ...
            $sql = "INSERT INTO products (id, unique_id, Vendor, Department, Departmentcode, DeviceType, Description, Qty, HSNSAC, InvoiceNo, InvoiceDate, Amount, CGST, SGST, Warranty, ExpiryDate, EmpCode, EmpName,SupRefNo, State, Location,Place,Branchcode)
				                   VALUES  ('$emapData[0]','$emapData[1]','$emapData[2]','$emapData[3]','$emapData[4]','$emapData[5]','$emapData[6]','$emapData[7]','$emapData[8]','$emapData[9]','$emapData[10]','$emapData[11]','$emapData[12]','$emapData[13]','$emapData[14]','$emapData[15]','$emapData[16]','$emapData[17]','$emapData[18]','$emapData[19]','$emapData[20]','$emapData[21]','$emapData[22]')";
...
<body>
    ...
    <div>
        <div class="flex flex-col flex-auto flex-shrink-0 min-h-screen antialiased text-black bg-zinc-100 ">
            ...
            ?>
            <div class="relative flex flex-col justify-center w-full h-full py-6 overflow-hidden antialiased text-gray-800 sm:py-12">
                    ...
                    <div class="mt-4 text-left bg-white rounded-lg shadow-xl">
                        ...
                        <div class="px-8 py-6 ">
                            <form action="" method="post" name="upload_excel" enctype="multipart/form-data">
                                ...
                                <input type="file" name="file" id="file" class="w-full py-3 mt-2 border rounded-md bg-zinc-100 hover:outline-none focus:outline-none focus:ring-sky-900 focus:ring-1">


                                <div class="flex items-baseline justify-end">
                                    <button type="submit" id="submit" name="Import" class="px-6 py-2 mt-4 text-white bg-pink-500 rounded-md hover:bg-pink-600">Upload</button>
                                </div>
                            </form>
