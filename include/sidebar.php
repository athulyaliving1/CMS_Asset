                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center justify-start">
                        ...
                        <div>
                            <img class="bg-white rounded-lg "
                                src="https://res.cloudinary.com/drywqd3hf/image/upload/v1675425966/care_1_vroxw3.png" alt="logo" />
                        </div>
                    </div>
                    ...
                    <p class="text-white text-xl mr-3 font-semibold">Welcome,<?php echo $_SESSION['fullName']; ?></p>
                        ...
                        <a href="logout.php"
                            ...
                            <svg class="w-8 h-8 mr-2 -ml-1 text-white svg-inline--fa fa-gem" viewBox="0 0 24 24"
                            ...
                            <ul class="pb-2 space-y-2">
                                ...
                                <li>
                                    <a href="devicemaster.php"
                                        ...
                                        <span
                                            class="inline-flex items-center justify-center px-2 ml-3 text-sm font-medium text-gray-800 bg-gray-200 rounded-full">New</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="product.php"
                                        ...
                                        <span class="flex-1 ml-3 whitespace-nowrap">Product Entry</span>
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="productexport1.php"
                                        ...
                                        <span class="flex-1 ml-3 whitespace-nowrap">Export Asset</span>
                                    </a>
                                </li>

                                <li>
                                    <a href="inward-outward.php"
                                        class="flex items-center p-2 text-base font-normal text-white rounded-lg hover:bg-pink-500 group ">
                                        <svg class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-white"
                                            fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd"
                                        ...
                                        <span class="flex-1 ml-3 whitespace-nowrap">Inward & Outward </span>
                                    </a>
                                </li>
                                <li>
                                    <a href="inward-outwardreport.php"
                                        class="flex items-center p-2 text-base font-normal text-white rounded-lg hover:bg-pink-500 group ">
                                        <svg class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-white"
                                            fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd"
